...
public unsafe readonly struct HWND :
    IHandleTSelfContracts<HWND>, IHandleTBaseHandleContracts<HWND, Handle>, IHandleContracts<HWND>
{
    #region Construct
...
public unsafe readonly struct HMenu :
    IHandleTSelfContracts<HMenu>, IHandleTBaseHandleContracts<HMenu, Handle>, IHandleContracts<HMenu>
{
    #region Construct
...
public unsafe readonly struct HCursor :
    IHandleTSelfContracts<HCursor>, IHandleTBaseHandleContracts<HCursor, Handle>, IHandleContracts<HCursor>
{
    #region Construct
...
/// <summary>
/// Handle to an icon (for example of a window or notifyicon in taskbar)
/// </summary>
[
    StructLayout(LayoutKind.Explicit, Size = 8),
    DebuggerDisplay("{ToString(),nq}"),
...
public unsafe readonly struct HIcon :
    IHandleTSelfContracts<HIcon>, IHandleTBaseHandleContracts<HIcon, Handle>, IHandleContracts<HIcon>
{
    #region Construct
