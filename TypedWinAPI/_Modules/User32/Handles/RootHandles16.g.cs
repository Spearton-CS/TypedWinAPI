...
public unsafe readonly struct ATOM :
    IHandle16TSelfContracts<ATOM>, IHandle16TBaseHandle16Contracts<ATOM, Handle16>, IHandle16Contracts<ATOM>
{
    #region Construct
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ATOM operator <<(ATOM a, int shift) => (ATOM)(a.Handle16Value << shift);
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ATOM operator >>(ATOM a, int shift) => (ATOM)(a.Handle16Value >> shift);
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ATOM operator >>>(ATOM a, int shift) => (ATOM)(a.Handle16Value >>> shift);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(ATOM a, void* b) => a.Handle16Value == b;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator !=(ATOM a, void* b) => a.Handle16Value != b;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator ATOM(void* ptr) => new((Handle16)ptr);
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator void*(ATOM h) => (void*)h.Handle16Value;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
