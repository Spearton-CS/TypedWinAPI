...
/// <summary>
/// Specifies standard virtual-key codes used by the Windows operating system for keyboard input.
/// </summary>
/// <remarks>
/// These constants represent the physical or logical keys on the keyboard and are passed via 
/// <c>WM_KEYDOWN</c>, <c>WM_KEYUP</c>, and related messages.
/// </remarks>
public enum VirtualKey : int
{
    ...
    Escape = 0x1B, Space = 0x20, Prior = 0x21, Next = 0x22, End = 0x23, Home = 0x24,
    Left = 0x25, Up = 0x26, Right = 0x27, Down = 0x28, Select = 0x29, Print = 0x2A,
    Execute = 0x2B, Snapshot = 0x2C, Insert = 0x2D, Delete = 0x2E, Help = 0x2F,
