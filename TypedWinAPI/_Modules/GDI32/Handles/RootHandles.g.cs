...
public unsafe readonly struct HDC :
    IHandleTSelfContracts<HDC>, IHandleTBaseHandleContracts<HDC, Handle>, IHandleContracts<HDC>
{
    #region Construct
...
public unsafe readonly struct HObj :
    IHandleTSelfContracts<HObj>, IHandleTBaseHandleContracts<HObj, Handle>, IHandleContracts<HObj>
{
    #region Construct
